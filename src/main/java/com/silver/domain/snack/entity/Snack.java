...
public class Snack {
    ...
    // --- 핵심 영양성분 ---
    @Column(name = "reference_serving_size")
    private Double referenceServingSize; // 1회 섭취참고량 (g)

    @Column(name = "energy_kcal")
    private Double energyKcal;       // 에너지 (kcal)

    @Column(name = "moisture_g")
    private Double moistureG;        // 수분 (g)
    ...
    public Snack(String foodCode, String name, String category, String subCategory, String manufacturer, String foodWeight,
                 Double referenceServingSize, Double energyKcal, Double moistureG, Double proteinG, Double fatG,
                 Double carbohydrateG, Double sugarG, Double sodiumMg, Double cholesterolMg,
                 Double saturatedFatG, Double transFatG) {
        this.foodCode = foodCode;
        this.name = name;
        this.category = category;
        this.subCategory = subCategory;
        this.manufacturer = manufacturer;
        this.foodWeight = foodWeight; // 추가된 필드
        this.referenceServingSize = referenceServingSize;
        this.energyKcal = energyKcal;
        this.moistureG = moistureG;
